...
<head>
  ...
  <link rel="shortcut icon" href="magazine/assets/images/logo2.png" type="image/x-icon">
  <meta name="description" content="Responsive Bootstrap HTML5 Magazine Template - Free Download">
  <title>Free HTML Bootstrap Magazine Template</title>
  <link rel="stylesheet" href="magazine/assets/web/assets/mobirise-icons/mobirise-icons.css">
  <link rel="stylesheet" href="magazine/assets/tether/tether.min.css">
  <link rel="stylesheet" href="magazine/assets/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="magazine/assets/bootstrap/css/bootstrap-grid.min.css">
  <link rel="stylesheet" href="magazine/assets/bootstrap/css/bootstrap-reboot.min.css">
  <link rel="stylesheet" href="magazine/assets/socicon/css/styles.css">
  <link rel="stylesheet" href="magazine/assets/dropdown/css/style.css">
  <link rel="stylesheet" href="magazine/assets/theme/css/style.css">
  <link rel="stylesheet" href="magazine/assets/mobirise/css/mbr-additional.css" type="text/css">
...
<section class="engine"><a href="https://mobirise.co/b">web page creator</a></section><section class="cid-qzam1qCjC4 mbr-fullscreen mbr-parallax-background" id="header2-0" data-rv-view="1301">

    

    <div class="mbr-overlay" style="opacity: 0.7; background-color: rgb(99, 90, 81);"></div>

    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1">HTML5 BOOTRSTRAP MAGAZINE TEMPLATE</h1>
                
                <p class="mbr-text pb-3 mbr-fonts-style display-5">
                    Aenean congue varius nisi, eu commodo nisl placerat eget. Integer dolor velit, tempus ut risus vitae, rutrum porta nibh. Aenean molestie orci nec risus sodales interdum. Proin efficitur sollicitudin mollis. 
                </p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-white display-4" href="https://mobirise.com/bootstrap-template/mobirise-free-template.zip">FREE DOWNLOAD</a>
...
<section class="header3 cid-qzam2Wut1Y" id="header3-1" data-rv-view="1304">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-figure" style="width: 100%;">
                <img src="magazine/assets/images/clem-onojeghuo-219193-2000x1488.jpg" alt="Mobirise" title="" media-simple="true">
            </div>

            <div class="media-content">
                <h2 class="mbr-section-title mbr-white pb-3 mbr-fonts-style display-1">
                    AUTUMN SALE</h2>
                
                <div class="mbr-section-text mbr-white pb-3 ">
                    <p class="mbr-text mbr-fonts-style display-5">
                        Purchase summer issues! 50% OFF</p>
                </div>
                <div class="mbr-section-btn"><a class="btn btn-md btn-black-outline display-4" href="#">ORDER NOW</a></div>
            </div>
        </div>
    </div>
...
<section class="header1 cid-qzamtcC8xs" id="header1-5" data-rv-view="1307">
...
<section class="features3 cid-qzaosgPVmz" id="features3-7" data-rv-view="1310">
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="magazine/assets/images/aravind-kumar-380959-2000x1333.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7"><strong>
                            There are Only 2 Types of Cats</strong></h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Nullam finibus malesuada orci id ultricies. Quisque tincidunt pharetra est id vehicula. Vestibulum at est a justo tempus tincidunt at a est.</p>
                    </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="magazine/assets/images/ross-sokolovski-115060-2000x1333.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7"><strong>
                            Being Smart is Not Enough</strong></h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Aliquam erat volutpat. Nullam et pellentesque dui. Fusce aliquet dictum orci in congue. Quisque auctor ipsum eu odio commodo laoreet.&nbsp;</p>
                    </div>
                    <div class="mbr-section-btn text-center"><a href="https://mobirise.com" class="btn btn-black display-4">
                            Read online</a></div>
                </div>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="magazine/assets/images/annie-spratt-251226-2000x1333.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7"><strong>3 Ways to Stop Being Sad</strong></h4>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Proin nec viverra lectus, in convallis nulla. Suspendisse id mauris sed purus pretium lobortis. Mauris et finibus dui, quis efficitur orci.&nbsp;</p>
                    </div>
...
<section class="cid-qzaqwpHEDD" id="footer1-b" data-rv-view="1316">
            ...
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://mobirise.com/">
                        <img src="magazine/assets/images/alisha-hieb-249784-2000x1333.jpg" alt="Mobirise" title="" media-simple="true">
                    </a>
                </div>
            </div>
  ...
  <script src="magazine/assets/web/assets/jquery/jquery.min.js"></script>
  <script src="magazine/assets/popper/popper.min.js"></script>
  <script src="magazine/assets/tether/tether.min.js"></script>
  <script src="magazine/assets/bootstrap/js/bootstrap.min.js"></script>
  <script src="magazine/assets/smooth-scroll/smooth-scroll.js"></script>
  <script src="magazine/assets/touch-swipe/jquery.touch-swipe.min.js"></script>
  <script src="magazine/assets/jarallax/jarallax.min.js"></script>
  <script src="magazine/assets/social-likes/social-likes.js"></script>
  <script src="magazine/assets/dropdown/js/script.min.js"></script>
  <script src="magazine/assets/theme/js/script.js"></script>
