...
<head>
  ...
  <link rel="shortcut icon" href="wedding/assets/images/logo4.png" type="image/x-icon">
  <meta name="description" content="">
  <title>Home</title>
  <link rel="stylesheet" href="wedding/assets/web/assets/mobirise-icons/mobirise-icons.css">
  <link rel="stylesheet" href="wedding/assets/tether/tether.min.css">
  <link rel="stylesheet" href="wedding/assets/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="wedding/assets/bootstrap/css/bootstrap-grid.min.css">
  <link rel="stylesheet" href="wedding/assets/bootstrap/css/bootstrap-reboot.min.css">
  <link rel="stylesheet" href="wedding/assets/theme/css/style.css">
  <link rel="stylesheet" href="wedding/assets/mobirise/css/mbr-additional.css" type="text/css">
...
<section class="header11 cid-qwTCuJooM6 mbr-fullscreen mbr-parallax-background" id="header11-1" data-rv-view="1127">
    ...
    <div class="container align-left">
        <div class="media-container-column mbr-white col-md-12">
            ...
            <h1 class="mbr-section-title py-3 mbr-fonts-style display-1">ALICE &amp; TOM</h1>
            <p class="mbr-text py-3 mbr-fonts-style display-5">We're getting married</p>
            <div class="mbr-section-btn py-4"><a class="btn btn-md btn-white-outline display-4" href="https://mobirise.com">DOWNLOAD TEMPLATE</a>
                    <a class="btn btn-md btn-white-outline display-4" href="https://mobirise.com">VIEW DEMO</a></div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-figure" style="width: 100%;">
                <img src="wedding/assets/images/camila-cordeiro-242255-4896x3264.jpg" alt="Mobirise" title="" media-simple="true">
            </div>
...
<section class="header3 cid-qwTDWLSdZ0 mbr-parallax-background" id="header3-7" data-rv-view="1136">
    ...
    <div class="container">
        <div class="media-container-row">
            <div class="mbr-figure" style="width: 100%;">
                <img src="wedding/assets/images/brooke-cagle-241288-5274x3516.jpg" alt="Mobirise" title="" media-simple="true">
            </div>
    ...
    <div class="container pt-5 mt-2">
        <div class=" countdown-cont align-center p-4">
            ...
            <div class="event-date align-left mbr-white">
                <h5 class="mbr-fonts-style display-7">2018/01/01 - Our Wedding Party</h5>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            ...
            <div class="mbr-figure pt-5" style="width: 60%;">
                <img src="wedding/assets/images/sam-wheeler-2304-3264x2448.jpg" alt="Mobirise" title="" media-simple="true">
            </div>
        </div>
    </div>
</section>
        ...
        <div class="carousel slide" data-ride="carousel" role="listbox">
            ...
            <div class="carousel-item ">
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="wedding/assets/images/1.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="wedding/assets/images/2.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                </div><div class="carousel-item ">
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="wedding/assets/images/3.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                </div><div class="carousel-item ">
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="wedding/assets/images/4.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                </div><div class="carousel-item ">
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="wedding/assets/images/5.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                </div></div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" data-form-email="true" value="Ib39DSjXc4/O2CZUXc4wpe3gVuGLgMbUFdEjEOc7vQi2RaFzRJsYkV93xAyLx3SHFCjZIixGMfT9Xn57Oq+TfLwEfkyjgiMnBGR3+tsMpawj6+TWMASOlg3KsN2zdIkX">
...
<section once="" class="cid-qwUcdm4XA3" id="footer6-k" data-rv-view="1175">
  ...
  <script src="wedding/assets/web/assets/jquery/jquery.min.js"></script>
  <script src="wedding/assets/popper/popper.min.js"></script>
  <script src="wedding/assets/tether/tether.min.js"></script>
  <script src="wedding/assets/bootstrap/js/bootstrap.min.js"></script>
  <script src="wedding/assets/jarallax/jarallax.min.js"></script>
  <script src="wedding/assets/countdown/jquery.countdown.min.js"></script>
  <script src="wedding/assets/bootstrap-carousel-swipe/bootstrap-carousel-swipe.js"></script>
  <script src="wedding/assets/smooth-scroll/smooth-scroll.js"></script>
  <script src="wedding/assets/theme/js/script.js"></script>
  <script src="wedding/assets/formoid/formoid.min.js"></script>
